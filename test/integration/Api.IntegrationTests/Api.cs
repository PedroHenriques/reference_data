...
public class ApiTests : IDisposable
{
  ...
  [Fact]
  public async Task Entities_Delete_ItShouldSoftDeleteTheProvidedEntityInTheDbAndReturnTheUpdatedDocument()
  {
    Entity[] seedData = [
      new Entity {
        Id = ObjectId.GenerateNewId().ToString(),
  ...
  [Fact]
  public async Task Entities_GetAll_ItShouldSoftDeleteTheProvidedEntityInTheDbAndReturnTheUpdatedDocument()
  {
    Entity[] seedData = [
      new Entity {
  ...
  [Fact]
  public async Task Entities_GetById_ItShouldSoftDeleteTheProvidedEntityInTheDbAndReturnTheUpdatedDocument()
  {
    Entity[] seedData = [
      new Entity {
        Id = "68bd8e86765fc5112cd9f2e2",
